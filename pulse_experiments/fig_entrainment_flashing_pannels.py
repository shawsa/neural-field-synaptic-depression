...
FILE_NAME = os.path.join(experiment_defaults.media_path, "entrainment_flashing_pannel")
...
for pannel, freq in [("success", 0.5), ("failure", 0.1)]:
    ...
    plt.plot(
        time.array, stim_speed * time.array + stim_start, "r-", label="stim center"
    )
    plt.legend()
