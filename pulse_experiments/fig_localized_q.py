...
FIG_FILE_NAME = 'spatially_localized_q'
...
plt.plot(space.array, v2_arr*max(theory)/max(v2_arr), 'b-', label='$v_2$')
...
plt.title('Pulse response to spatially localized stimulus (q)')
plt.tight_layout()
for ext in ['.eps', '.png']:
